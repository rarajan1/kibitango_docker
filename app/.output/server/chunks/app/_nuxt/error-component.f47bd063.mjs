...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = vue_cjs_prod.defineAsyncComponent(() => import('./error-404.4aba3351.mjs'));
    const _Error = vue_cjs_prod.defineAsyncComponent(() => import('./error-500.cd46a29a.mjs'));
...
//# sourceMappingURL=error-component.f47bd063.mjs.map
